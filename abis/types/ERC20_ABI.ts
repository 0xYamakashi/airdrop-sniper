...
export interface ERC20_ABIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "name"
      | "approve"
...
export interface ERC20_ABI extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20_ABI;
  waitForDeployment(): Promise<this>;

  interface: ERC20_ABIInterface;
