...
export interface STABLE_POOL_FACTORY_ABIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createPool"
      | "getDeployData"
...
export interface STABLE_POOL_FACTORY_ABI extends BaseContract {
  connect(runner?: ContractRunner | null): STABLE_POOL_FACTORY_ABI;
  waitForDeployment(): Promise<this>;

  interface: STABLE_POOL_FACTORY_ABIInterface;
