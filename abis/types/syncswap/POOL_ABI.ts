...
export interface POOL_ABIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface POOL_ABI extends BaseContract {
  connect(runner?: ContractRunner | null): POOL_ABI;
  waitForDeployment(): Promise<this>;

  interface: POOL_ABIInterface;
  ...
  getAmountIn: TypedContractMethod<
    [_tokenOut: AddressLike, _amountOut: BigNumberish, _sender: AddressLike],
    [bigint],
    "view"
  >;

  getAmountOut: TypedContractMethod<
    [_tokenIn: AddressLike, _amountIn: BigNumberish, _sender: AddressLike],
    [bigint],
    "view"
  >;
